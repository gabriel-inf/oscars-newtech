...
@Slf4j
@Transactional
public class TopPceTestNonPalindromic extends AbstractCoreTest
{
    @Autowired
    ...
    public void nonPalPceSymmTest1()
    {
        ...
        requestedBlueprint = testBuilder.buildRequest(srcPort, srcDevice, dstPort, dstDevice, azBW, zaBW, palindrome, survivability, vlan, 1, 1, 1, "nonPalTest");
    ...
    public void multiFixtureTest()
    {
        ...
        requestedSched = testBuilder.buildSchedule(startDate, endDate);
        requestedBlueprint = testBuilder.buildRequest(srcPorts, srcDevice, dstPorts, dstDevice, azBW, zaBW, palindrome, survivability, vlan, 1, 1, 1, "nonPalTest");
