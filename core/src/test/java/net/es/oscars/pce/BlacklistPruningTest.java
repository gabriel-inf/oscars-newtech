...
@Slf4j
@Transactional
public class BlacklistPruningTest extends AbstractCoreTest {
    ...
    public RequestedBlueprintE setupTest(String srcPort, String srcDevice, String dstPort, String dstDevice, Set<String> blacklist){
        ...
        String vlan = "any";
        return testBuilder.buildRequest(srcPort, srcDevice, dstPort, dstDevice, azBW, zaBW, palindrome, survivability, vlan, blacklist, 1, 1, 1, "blacklistTest");
    }
