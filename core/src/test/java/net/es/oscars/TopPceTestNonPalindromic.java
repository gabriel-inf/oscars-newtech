...
public class TopPceTestNonPalindromic
{
    ...
    public void nonPalPceAsymmTest6()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            else if(fix1.getIfceUrn().getUrn().equals("portZ"))
            {
    ...
    public void asymmPceTest2()
    {
        ...
        allResJunctions.stream()
                .forEach(j -> {
                    ...
                    int fixAInBW = fixA.getReservedBandwidth().getInBandwidth();
                    int fixAEgBW = fixA.getReservedBandwidth().getEgBandwidth();
                    int fixZInBW = fixZ.getReservedBandwidth().getInBandwidth();
                    int fixZEgBW = fixZ.getReservedBandwidth().getEgBandwidth();
                    ...
                    if(j.getDeviceUrn().getUrn().equals("nodeL"))
                    {
                        ...
                        if(fixA.getIfceUrn().getUrn().equals("nodeL:1") && fixZ.getIfceUrn().getUrn().equals("nodeL:2"))
                        {
                            assert(fixA.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                            assert(fixA.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                            assert(fixZ.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
                            assert(fixZ.getReservedBandwidth().getEgBandwidth().intValue() == azBW);
                        }
                        else
                        {
                            assert(fixZ.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                            assert(fixZ.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                            assert(fixA.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
                            assert(fixA.getReservedBandwidth().getEgBandwidth().intValue() == azBW);
                        }
                    }
                    else if(j.getDeviceUrn().getUrn().equals("nodeM"))
                    {
                        ...
                        if(fixA.getIfceUrn().getUrn().equals("nodeM:1") && fixZ.getIfceUrn().getUrn().equals("portZ"))
                        {
                            assert(fixA.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                            assert(fixA.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                            assert(fixZ.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
                    ...
                    else if(j.getDeviceUrn().getUrn().equals("nodeP"))
                    {
                        ...
                        if(fixA.getIfceUrn().getUrn().equals("portA") && fixZ.getIfceUrn().getUrn().equals("nodeP:1"))
                        {
                            assert(fixA.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                            assert(fixA.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                            assert(fixZ.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
    ...
    public void asymmPceTest3()
    {
        ...
        int fixJ1InBW = fixJ1.getReservedBandwidth().getInBandwidth();
        int fixJ1EgBW = fixJ1.getReservedBandwidth().getEgBandwidth();
        int fixJ2InBW = fixJ2.getReservedBandwidth().getInBandwidth();
        int fixJ2EgBW = fixJ2.getReservedBandwidth().getEgBandwidth();
        ...
        if(fixJ1.getIfceUrn().getUrn().equals("portA") && fixJ2.getIfceUrn().getUrn().equals("nodeK:1"))
        {
            assert(fixJ1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
            assert(fixJ1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
            assert(fixJ2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
            assert(fixJ2.getReservedBandwidth().getEgBandwidth().intValue() == azBW);
        }
        else
        {
            assert(fixJ2.getReservedBandwidth().getInBandwidth().intValue() == azBW);
            assert(fixJ2.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
            assert(fixJ1.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
            assert(fixJ1.getReservedBandwidth().getEgBandwidth().intValue() == azBW);
        }
    ...
    public void asymmPceTest4()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            ReservedVlanFixtureE fix1 = iterF.next();
            ReservedVlanFixtureE fix2 = iterF.next();
            int fix1InBW = fix1.getReservedBandwidth().getInBandwidth();
            int fix1EgBW = fix1.getReservedBandwidth().getEgBandwidth();
            int fix2InBW = fix2.getReservedBandwidth().getInBandwidth();
            int fix2EgBW = fix2.getReservedBandwidth().getEgBandwidth();
    ...
    public void asymmPceTest5()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            if(oneJunc.getDeviceUrn().getUrn().equals("nodeK"))
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("portA") && fix2.getIfceUrn().getUrn().equals("nodeK:2"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
            ...
            else
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeS:1") && fix2.getIfceUrn().getUrn().equals("portZ"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
    ...
    public void asymmPceTest7()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            if(oneJunc.getDeviceUrn().getUrn().equals("nodeK"))
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("portA") && fix2.getIfceUrn().getUrn().equals("nodeK:1"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
            ...
            else
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeL:1") && fix2.getIfceUrn().getUrn().equals("portZ"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
    ...
    public void asymmPceTest9()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            else
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeP:1") && fix2.getIfceUrn().getUrn().equals("portZ"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
    ...
    public void asymmPceTest10()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            else if(oneJunc.getDeviceUrn().getUrn().equals("nodeL"))
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeL:1") && fix2.getIfceUrn().getUrn().equals("nodeL:2"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
            ...
            else
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeM:1") && fix2.getIfceUrn().getUrn().equals("portZ"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
    ...
    public void asymmPceTest12()
    {
        ...
        for(ReservedVlanJunctionE oneJunc : allResJunctions)
        {
            ...
            else if(oneJunc.getDeviceUrn().getUrn().equals("nodeM"))
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeM:1") && fix2.getIfceUrn().getUrn().equals("nodeM:2"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
            ...
            else
            {
                ...
                if(fix1.getIfceUrn().getUrn().equals("nodeQ:2") && fix2.getIfceUrn().getUrn().equals("portZ"))
                {
                    assert(fix1.getReservedBandwidth().getInBandwidth().intValue() == azBW);
                    assert(fix1.getReservedBandwidth().getEgBandwidth().intValue() == zaBW);
                    assert(fix2.getReservedBandwidth().getInBandwidth().intValue() == zaBW);
