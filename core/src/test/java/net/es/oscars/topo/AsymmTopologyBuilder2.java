...
@Slf4j
@Component
public class AsymmTopologyBuilder2
{
    @Autowired
    ...
    public void buildAsymmTopo3()
    {
        ...
        List<Integer> bwPortK2 = Arrays.asList(30, 20);
        List<Integer> bwPortQ1 = Arrays.asList(60, 20);
        List<Integer> bwPortQ2 = Arrays.asList(20, 60);
        List<Integer> bwPortR1 = Arrays.asList(20, 30);
        List<Integer> bwPortR2 = Arrays.asList(30, 20);
        List<Integer> bwPortS1 = Arrays.asList(60, 20);
        List<Integer> bwPortS2 = Arrays.asList(20, 30);
    ...
    public void buildAsymmTopo4()
    {
        ...
        List<Integer> bwPortL3 = Arrays.asList(30, 20);
        List<Integer> bwPortM1 = Arrays.asList(60, 20);
        List<Integer> bwPortM2 = Arrays.asList(20, 30);
        List<Integer> bwPortN1 = Arrays.asList(20, 30);
        List<Integer> bwPortN2 = Arrays.asList(30, 20);
        portBWs.put(portA, bwPortA);
        portBWs.put(portZ, bwPortZ);
        portBWs.put(portK1, bwPortK1);
    ...
    public void buildAsymmTopo5()
    {
        ...
        List<Integer> bwPortQ2 = Arrays.asList(20, 60);
        List<Integer> bwPortQ3 = Arrays.asList(30, 20);
        List<Integer> bwPortR1 = Arrays.asList(20, 30);
        List<Integer> bwPortR2 = Arrays.asList(30, 20);
        List<Integer> bwPortS1 = Arrays.asList(60, 20);
        List<Integer> bwPortS2 = Arrays.asList(20, 30);
